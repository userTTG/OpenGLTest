 ...
 * @Version 1.0
 */
public class Texture2dCubeMultiRender implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        int fragmentShader = loadShader(GLES20.GL_FRAGMENT_SHADER, ResReadUtils.readResource(R.raw.fragment_texture_2d_multi_shade_2));
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES20.glVertexAttribPointer(texHandle2,2,GLES20.GL_FLOAT,false,0,vertexTexBuffer);
